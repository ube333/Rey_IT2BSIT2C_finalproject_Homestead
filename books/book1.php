...
<div class="row py-5 px-4">
    <div class="col-md-5 mx-auto">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <h5 class="mb-0">Title: Untold </h5>
                <h5 class="mb-0">Author: Geir Westrul </h5>
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">“Where are we?” the old man said.
...
“I am guided,” Demodocus said, “by the beacons of hope, shining like candles across the worlds. I see hope in the darkness. I walk through darkness towards hope. All I need from those whose stories are yet untold, is their faintest glow of hope.”</p>
