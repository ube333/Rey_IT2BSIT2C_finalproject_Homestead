...
<div class="row py-5 px-4">
    <div class="col-md-5 mx-auto">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                <h5 class="mb-0">Title: Strawberry Jam Under the Sea </h5>
                <h5 class="mb-0">Author: Aeris Walker </h5>
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">I am swimming, thrusting my arms through golden water—golden like oil. The water grows thick and syrupy, then it pulls me under. I’m in a bottle, glass sloping above me. Someone tilts and pours, and I slide onto a pan, palms burning from the heat. I slip and roll in the slick spill. Steam rises off my wet hair. Then I am smothered under the sticky weight of raw meat.
